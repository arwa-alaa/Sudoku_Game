...
public class Sudoku extends JFrame {
    ...
    public Sudoku(int i) {
        ...
        JLabel hnt1 = new JLabel("Hint: 1/3");
        JLabel hnt2 = new JLabel("Hint: 2/3");
        JLabel hnt3 = new JLabel("Hint: 3/3");
        JPanel controlPanel = new JPanel();
        controlPanel.setLayout(new FlowLayout());
        //  controlPanel.add(new JLabel("Hint: 0/3"));
        ...
        switch (counter_Hint) {
            case 1:
                controlPanel.add(hnt1);
                break;
            case 2:
                controlPanel.add(hnt2);
                break;
            case 3:
                controlPanel.add(hnt3);
                break;
        }
    ...
    class HintListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (counter_Hint > 3)
            {
                JOptionPane.showMessageDialog(f, "Maximum of Hints", "Error", JOptionPane.ERROR_MESSAGE);
            }
            else
            {
    ...
    class MoveListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
                    ...
                    if (sudokuLogicE.isLegalMove(row, col, val)) {
                        ...
                        if (val == C_Solved_E[row][col]) {
                            ...
                            sudokuBoard1.repaint();
                                  ...
                                  JOptionPane.showMessageDialog(f,  "Wrong Value!", "Error", JOptionPane.ERROR_MESSAGE);
                            counter_mistakes++;
                        ...
                        JOptionPane.showMessageDialog(f, "InValid Row, Col, or Value.", "Error", JOptionPane.ERROR_MESSAGE);
                     }
            ...
            if (sudokuLogicH.isfull()) {
                ...
                JOptionPane.showMessageDialog(f, "Please enter numeric values.",
